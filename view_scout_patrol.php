<?php
  $page_title = 'View Scouts In $_GET['patrol'] Patrol';
...
<?php include_once('layouts/header.php'); ?>
  <div class="row">
   ...
   <div class="pull-left">
		<a href="view_scout_select_patrol.php" class="btn btn-primary"><i class="glyphicon glyphicon-arrow-left"></i> Return To Selection</a><br><br>
        </div>
        </div>
...
<script>
function printDiv() {
    newWin = window.open("scout_print_patrol.php?patrol=<?php echo $print;?>");
    setTimeout(function (){
    newWin.print();
    newWin.close();
